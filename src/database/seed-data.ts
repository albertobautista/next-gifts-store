...
export const initialData: SeedData = {
  products: [
    ...
    {
      description:
        "Introducing the Tesla Raven Collection. The Men's Raven Lightweight Zip Up otton blend for versatility in any season. The hoodie features subtle thermoplastic polyurethane Tesla logos on the left chest and below the back collar, a concealed chest pocket with custom matte zipper pulls and a french terry interior. Made from 70% bamboo and 30% cotton.",
      ...
      type: "shirts",
      tags: ["shirt"],
      title: "Men's Raven Lightweight Zip Up",
      gender: "men",
    },
    ...
    {
      description:
        "Cruise the playground in style with the Kids Corp Jacket. Modeled after the original Tesla Corp Jacket, the Kids Corp Jacket features the same materials but at a pint-sized scale.",
